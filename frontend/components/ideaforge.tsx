...
import { Brain, Lightbulb, Zap, Code, CheckCircle, ArrowRight } from 'lucide-react'
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            {[
              {
                ...
                description: "Leverage advanced machine learning algorithms to generate comprehensive test scenarios."
              },
              {
                icon: <Zap className="w-8 h-8 text-indigo-600" />,
                title: "Smart Coverage Analysis",
                description: "Automatically identify gaps in test coverage and suggest additional scenarios."
              },
              {
                icon: <Code className="w-8 h-8 text-indigo-600" />,
                title: "Code Integration",
                description: "Seamlessly integrate generated test scenarios into your existing test suite."
              }
            ].map((feature, index) => (
        ...
        >
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
            <h2 className="text-3xl font-bold mb-8">Why Choose IdeaForge?</h2>
